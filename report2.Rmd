...
```{r, echo=FALSE }
df2flextable(sampleData3[9,],align_body = "left") 
```



```{r,results='asis'}
df2flextable( sampleData3 ,vanilla= FALSE )
```

### mytable object 
You can add mytable object with the following R code. 
```{r, echo=FALSE }
df2flextable(sampleData3[11,],align_body = "left") 
```
